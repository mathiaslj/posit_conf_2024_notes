...
See the notes on [duckplyr](keynotes/04duckdb.qmd#sec:duckplyr).
...
-   **Scheduled running**: Use [crontab.guru](https://crontab.guru/) for cron syntax (see examples of usage in [workshop notes](../workshop.qmd#sec:cron))
-   [r-lib/actions examples](https://github.com/r-lib/actions/tree/v2-branch/examples)
-   Use environment variables in the GitHub action to pass personal access tokens (PATs) to authorise publishing, API keys, etc.
    -   See [Using environmental variables with GitHub actions and Posit cloud connect](../workshop.qmd#sec:envvar_ci) for more details
